pub mod des_cons {
    ...
    /// Definimos las permutaciónes que vamos a utilizar en el proceso

    pub const KEY_56: &str = "0001001100110100010101110111100110011011101111001101111111110001";
    ...
    // Define a constant to use it as a permutation P
    pub const P: [usize; 32] = [
        16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26, 5, 18, 31, 10, 2, 8, 24, 14, 32, 27, 3, 9,
        19, 13, 30, 6, 22, 11, 4, 25,
    ];

    pub const S_BOXES: [[[usize; 16]; 4]; 8] = [S1, S2, S3, S4, S5, S6, S7, S8];

    /// Tenemos también cada una de las S-boxes que vamos a utilizar
    pub const S1: [[usize; 16]; 4] = [
    ...
    /// Contamos con nuestra permutación inicial IP
    ...
    // Así como la permutación inversa de la inicial, FP
    // que aplicarémos al final de los 16 rounds.
